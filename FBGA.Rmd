...
```
#### TEMPORARY WORKSPACE - COMBINED THE TWO FBGA PLOTS
...
```{r}
##MANUALLY RUN THE MANN KENDALL TEST - HIGH TEMPERATURE
...
##MANUALLY RUN THE MANN KENDALL TEST - WBGT TEMPERATURE
#Set up month and year columns
...
```
According to the slope, the High Temperature is increasing at a rate of 0.008230453 over the 1973-2022 data period. That is an increase of 0.428 degrees C (or about 0.77 degrees F).
